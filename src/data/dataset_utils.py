...
class DatasetEnum(Enum):
    ...
    # CDFSL
    CDFSL = "CDFSL"
    CARS = "cdfsl/cars_cdfsl"
    BIRD_CDFSL = "cdfsl/CUB_200_2011"
    PLACES = "cdfsl/places_cdfsl"
    PLANTAE = "cdfsl/plantae_cdfsl"
    ...
    def get_clusters(self):
        if self == DatasetEnum.MetaBTAF:
            return [
                DatasetEnum.BIRD,
                DatasetEnum.TEXTURE,
                DatasetEnum.AIRCRAFT,
                DatasetEnum.FUNGI,
            ]
        elif self == DatasetEnum.MetaCIO:
            return [
                DatasetEnum.CIFAR_FS,
                DatasetEnum.miniimagenet,
                DatasetEnum.omniglot_py,
            ]
        elif self == DatasetEnum.MetaABF:
            return [DatasetEnum.AIRCRAFT, DatasetEnum.BIRD, DatasetEnum.FUNGI]
        elif self == DatasetEnum.CDFSL:
            return [
                DatasetEnum.BIRD_CDFSL,
                DatasetEnum.CARS,
                DatasetEnum.PLACES,
                DatasetEnum.PLANTAE,
                DatasetEnum.miniimagenet,
